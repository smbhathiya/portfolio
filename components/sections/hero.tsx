      ...
      <div className="container px-4 md:px-8 max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="lg:col-span-7 flex flex-col gap-8 order-2 lg:order-1">
            ...
            >
              <h1 className="text-6xl sm:text-7xl md:text-8xl font-black uppercase tracking-tight leading-[1] flex flex-col gap-1">
                <span>Bhathiya</span>
                <span className="text-primary">Lakshan</span>
              </h1>
            </motion.div>
            ...
            >
              <Button
                size="lg"
                className="w-full sm:w-auto h-12 px-8 text-sm font-semibold tracking-wide group"
                onClick={() => {
              ...
              <div className="flex items-center gap-1">
                {socials.map(({ icon: Icon, href, label }) => (
                  <a
                    ...
                    aria-label={label}
                    className="w-10 h-10 flex items-center justify-center rounded-lg text-muted-foreground hover:text-foreground hover:bg-foreground/5 transition-colors"
                  >
            ...
            >
              <div className="relative aspect-square rounded-2xl overflow-hidden border border-border bg-muted">
                ...
                <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between gap-2">
                  <span className="text-[10px] font-bold tracking-widest uppercase bg-background/90 backdrop-blur-sm px-3 py-1.5 rounded-md border border-border">
                    Software Engineer
                  </span>
                  <span className="text-[10px] font-bold tracking-widest uppercase bg-background/90 backdrop-blur-sm px-3 py-1.5 rounded-md border border-border flex items-center gap-1.5">
                    <IconWorld className="w-3 h-3 text-primary" /> Sri Lanka
                  </span>
                </div>
              </div>
            </motion.div>
