            ...
            <div className="space-y-6">
              {contactInfo.map(({ icon: Icon, label, value, href }, i) => (
                ...
                >
                  ...
                  <div>
                    <p className="text-[11px] md:text-xs font-semibold uppercase tracking-widest text-muted-foreground/50 mb-0.5">
                      {label}
                    </p>
          ...
          >
            <div className="border border-border/80 rounded-xl p-8 bg-background/40 backdrop-blur-sm shadow-xl relative overflow-hidden group">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    <label
                      ...
                      className="text-xs md:text-sm font-semibold uppercase tracking-wide text-muted-foreground"
                    >
                      Full Name
                    </label>
                    <input
                ...
                <Button
                  type="submit"
                  className="w-full h-12 text-sm md:text-base font-semibold tracking-wide cursor-pointer group hover:opacity-95 transition-all active:scale-98"
                >
                  Send Message
